              ...
              <div class='columns'>
                <div class='column is-8 is-offset-2'>
                  <div class='content is-medium'>
                    ...
                    <p>
                      This is a starter template for creating a beautiful, customizable blog with
                      minimal effort. You’ll only have to change a few settings and you’re ready to
                      go. As with all Jigsaw sites, configuration settings can be found in config
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div class='columns is-variable is-8'>
                <div class='column is-5 is-offset-1 '>
                  <div class='content is-medium'>
                    ...
                    <p class='has-text-dark'>
                      This starter template includes a custom 404 Not Found error page, located at
                      /source/404.blade.php. To preview the 404 page, you can visit /404 in your
                      browser. Depending...
                    </p>
                  </div>
                </div>
                <div class='column is-5'>
                  <div class='content is-medium'>
                    ...
                    <p class='has-text-dark'>
                      To provide fast, local search of your blog, this starter template comes with a
                      pre-built Vue.js component that uses Fuse.js. Fuse.js is a "lightweight
                      fuzzy-search library with no...
                    </p>
                  </div>
                </div>
              </div>
      ...
      <footer class='footer'>
        <div class='content has-text-centered'>
          <p>
            ...
            <a href='http://jigsaw-blog-staging.tighten.co/'>jigsaw-blog</a>. The source code is
            licensed
